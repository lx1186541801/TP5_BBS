<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:57:"D:\WWW\tp5\public/../application/admin\view\cate\add.html";i:1567957931;s:49:"D:\WWW\tp5\application\admin\view\Layout\app.html";i:1567925615;s:52:"D:\WWW\tp5\application\admin\view\Layout\header.html";i:1567957759;s:50:"D:\WWW\tp5\application\admin\view\Layout\left.html";i:1567925837;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
	                                ...
	                                <div class="row mt-4">
	                                    <div class="col-md-8">
	                                        <div class="form-group">
	                                            ...
	                                            <input id="required-input" name="catename" class="form-control" value="">
	                                        </div>
	                                    </div>
	                                </div>
	                                ...
	                                <div class="row mt-4">
	                                    <div class="col-md-8">
	                                        <div class="form-group">
	                                            ...
	                                            <textarea id="textarea" name="des" class="form-control" rows="6"></textarea>
	                                        </div>
	                                    </div>
	                                </div>
	                                <div class="row mt-4">
